...
func (_Factory *FactoryCaller) Migrator(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Factory.contract.Call(opts, &out, "migrator")
...
//
// Solidity: function migrator() view returns(address)
func (_Factory *FactorySession) Migrator() (common.Address, error) {
	return _Factory.Contract.Migrator(&_Factory.CallOpts)
}

// Migrator is a free data retrieval call binding the contract method 0x7cd07e47.
//
// Solidity: function migrator() view returns(address)
func (_Factory *FactoryCallerSession) Migrator() (common.Address, error) {
	return _Factory.Contract.Migrator(&_Factory.CallOpts)
}
...
func (_Factory *FactoryTransactor) SetMigrator(opts *bind.TransactOpts, _migrator common.Address) (*types.Transaction, error) {
	return _Factory.contract.Transact(opts, "setMigrator", _migrator)
}

// SetMigrator is a paid mutator transaction binding the contract method 0x23cf3118.
//
// Solidity: function setMigrator(address _migrator) returns()
func (_Factory *FactorySession) SetMigrator(_migrator common.Address) (*types.Transaction, error) {
	return _Factory.Contract.SetMigrator(&_Factory.TransactOpts, _migrator)
}

// SetMigrator is a paid mutator transaction binding the contract method 0x23cf3118.
//
// Solidity: function setMigrator(address _migrator) returns()
func (_Factory *FactoryTransactorSession) SetMigrator(_migrator common.Address) (*types.Transaction, error) {
	return _Factory.Contract.SetMigrator(&_Factory.TransactOpts, _migrator)
}
